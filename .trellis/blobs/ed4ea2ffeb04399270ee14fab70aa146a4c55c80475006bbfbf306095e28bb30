...
import { Database, Loader2, CheckCircle2, AlertCircle, X, ChevronRight } from 'lucide-react'
        ...
        <div className="p-4 space-y-4">
          ...
          {stats && (
            <>
              <Separator />
              <div className="space-y-2">
                <p className="text-xs font-medium text-muted-foreground uppercase">Graph Stats</p>
                <div className="grid grid-cols-2 gap-2">
                  <StatItem label="Files" value={stats.entityCount} />
                  <StatItem label="Facts" value={stats.factCount} />
                  <StatItem label="Links" value={stats.linkCount} />
                </div>
              </div>
            </>
          )}
          ...
          {!scanning && !stats && (
            <div className="text-xs text-muted-foreground space-y-2">
              <p>Indexing builds a queryable knowledge graph of your files.</p>
              <div className="space-y-1">
